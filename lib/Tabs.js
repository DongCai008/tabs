...
function Tabs(_ref, ref) {
  var id = _ref.id,
    ...
    tabSeparator = _ref.tabSeparator,
    locale = _ref.locale,
  ...
  return /*#__PURE__*/React.createElement(_TabContext.default.Provider, {
    ...
    ref: ref,
    id: id,
    className: (0, _classnames.default)(prefixCls, "".concat(prefixCls, "-").concat(mergedTabPosition), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-mobile"), mobile), "".concat(prefixCls, "-editable"), editable), "".concat(prefixCls, "-rtl"), rtl), className)
...
var _default = exports.default = ForwardTabs;