...
function TabNavList(props, ref) {
  ...
  var className = props.className,
    ...
    tabSeparator = props.tabSeparator,
    children = props.children,
    onTabClick = props.onTabClick,
    onTabScroll = props.onTabScroll;
  var tabsWrapperRef = (0, _react.useRef)();
  var tabListRef = (0, _react.useRef)();
  var operationsRef = (0, _react.useRef)();
  var innerAddButtonRef = (0, _react.useRef)();
  ...
  var tabOffsets = (0, _useOffsets.default)(tabs, tabSizes, wrapperScrollWidth);
  // ========================== Util =========================
  ...
  // ========================= Mobile ========================
  var touchMovingRef = (0, _react.useRef)();
  ...
  var tabNodes = tabs.map(function (tab, i) {
    ...
    return /*#__PURE__*/React.createElement(_react.Fragment, {
      key: key
    }, /*#__PURE__*/React.createElement(_TabNode.default, {
      id: id,
      prefixCls: prefixCls,
      tab: tab
    ...
    }), hasTabSep && tabSeparator && /*#__PURE__*/React.createElement("span", null, tabSeparator));
  });
...
var _default = exports.default = /*#__PURE__*/React.forwardRef(TabNavList);